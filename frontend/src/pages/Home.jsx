        ...
        <div className="bg-[#030208] text-white overflow-x-hidden" style={{ fontFamily: "'Inter', sans-serif" }}>
            ...
            <section className="py-16 relative overflow-hidden">
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
                        ...
                        <div className="relative rounded-3xl overflow-hidden mb-6"
                            ...
                            <div className="flex flex-col lg:flex-row">
                                ...
                                <div className="relative flex-1 p-8 sm:p-10 lg:p-14 flex flex-col items-center lg:items-start text-center lg:text-left border-t border-white/5 lg:border-t-0">
                                    ...
                                    <h3 className="relative z-10 text-white/70 font-bold text-xl sm:text-2xl mb-3"
                                        style={{ fontFamily: "'Playfair Display', serif" }}>
                                        Platform fee — that's it
                                    </h3>
                                    <p className="relative z-10 text-white/35 text-sm sm:text-base leading-relaxed max-w-sm">
                                        Our only fee. No hidden charges, no withdrawal fees, no surprise deductions. Just 20%.
                                    </p>

                                    {/* Revenue bar */}
                                    <div className="relative z-10 mt-8 w-full max-w-sm">
                                        <div className="flex justify-between text-xs text-white/20 mb-2 font-medium">
                    ...
                    {/* ── Three trust cards: Weekly payout, No hidden fees, Instant settlement ── */}
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">

                        {/* Card 1: Weekly Payments */}
                        <Reveal delay={0.05}>
                            <motion.div
                                className="relative p-6 sm:p-8 rounded-2xl overflow-hidden group cursor-default h-full flex flex-col"
                                style={{
